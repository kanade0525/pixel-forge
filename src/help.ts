...
const HELP: Record<string, Help> = {
  ...
  effects: {
    title: '加工（変換前のエフェクト）',
    body: 'ドット化する<b>前</b>に写真を加工します。すべて任意で、既定はオフ。<br><b>輝度／コントラスト</b>：明るさと明暗差を調整。<br><b>ポスタリゼーション</b>：色を数段階に減らしてフラットな塗りに（アニメ塗り向き）。<br><b>カートゥーン化（輪郭線）</b>：輪郭を検出して黒い線を描き、アニメ調に。<br><b>CCトナー（網点）</b>：印刷のトナー（ハーフトーン）風の点々で陰影を表現。<br><b>モザイク</b>：さらに粗いブロックにまとめて荒いモザイクに。<br>「加工をリセット」で全部オフに戻せます。',
  },
  dither: {
    title: '色の混ぜ方（ディザリング）',
